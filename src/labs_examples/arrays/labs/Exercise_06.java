...
public class Exercise_06 {
    ...
    public static void main(String[] args){
        ...
        // ANSWER: since we are swapping numbers from one half with the equivalent from the other half, we only need
        // to traverse half of the array. By the time we reach the middle, the other half will be swapped as well.
